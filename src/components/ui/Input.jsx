...
export default function Input({
  ...
  const baseStyle = 'w-full text-gray-800 rounded py-3 px-2 text-sm focus:outline-none placeholder:text-[.8rem]';

  // Variant styles for different input appearances
  const inputVariants = {
    underline: 'border-b-2 pl-14 border-[#002D62] focus:border-[#002D62]',
    default:   'bg-white shadow border border-[#69315E] focus:ring-blue-500',
  };
